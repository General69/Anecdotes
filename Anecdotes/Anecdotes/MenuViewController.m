...
@interface MenuViewController ()<UINavigationControllerDelegate,UIImagePickerControllerDelegate,UIActionSheetDelegate,VPImageCropperDelegate>
...
-(void)imageView{
    ...
    CGRect imageRrect = CGRectMake(0, 0,self.portraitImageView.frame.size.width, self.portraitImageView.frame.size.height);
    UIGraphicsBeginImageContext(imageRrect.size);
    [self.portraitImageView.image drawInRect:CGRectMake(1,1,self.portraitImageView.frame.size.width-2,self.portraitImageView.frame.size.height-2)];
    self.portraitImageView.image = UIGraphicsGetImageFromCurrentImageContext();
    UIGraphicsEndImageContext();
    
    [self.portraitImageView.layer addAnimation:animation forKey:nil];
}
...
- (UIImageView *)portraitImageView {
    if (!_portraitImageView) {
        _portraitImageView = [[UIImageView alloc] initWithFrame:CGRectMake(280 / 2 - 50, 50, 100, 100)];
